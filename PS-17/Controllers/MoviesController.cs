...
namespace PS_17.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class MoviesController : ControllerBase
    {
        private readonly PS_17DbContext _context;

        public MoviesController(PS_17DbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Movies>> PostMovies(Movies movies)
        {
          if (_context.Movies == null)
          {
              return Problem("Entity set 'PS_17DbContext.Movies'  is null.");
          }
